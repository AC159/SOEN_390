...
function Home(props) {
  ...
  return (
    <div className={styles["home-outer-container"]}>
      <div className={styles["todays-new-title"]}>Today's News</div>
      <hr />
      <Carousel>
        <Carousel.Item>
          <img
      ...
      <Accordion defaultActiveKey="-1" flush>
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            CoviCare links patients to medical doctors and gives access to
            health and immigration officers to follow patients current COVID-19
            status to ultimately<br></br>
            reduce the spread of the Coronavirus. CoviCare aims to help you
            learn and protect yourself and your community.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="1">
          <Accordion.Header>
            Are COVID protocols still in place all over Quebec?
          </Accordion.Header>
          <Accordion.Body>
            Yes. Until further notice, all public places with a capacity of more
            than a 100 people are restricted from letting civilians in.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="2">
          <Accordion.Header>
            What are general tips for dealing with COVID19?
          </Accordion.Header>
          <Accordion.Body>
            <ul>
        ...
        <Accordion.Item eventKey="3">
          <Accordion.Header>
            How do you deal with COVID-induced stress and anxiety?
          </Accordion.Header>
          <Accordion.Body>
            <ul>
      ...
      <div className={styles["todays-new-title"]}>Symptoms</div>
      ...
      <div className={styles["symptoms"]}>
        ...
        <p className={styles["symptoms-list"]}>
          Get assigned to a doctor using CoviCare.{" "}
          <strong>
            Seek immediate medical attention if you have serious symptoms.
          </strong>{" "}
          People with mild symptoms who are otherwise healthy should<br></br>
          ...
          can take up to 14 days.<br></br>
        </p>
      </div>
      <hr />

      <div className={styles["todays-new-title"]}>
        What to do if you or someone you've been in contact with has tested
      ...
      <div className={styles["tips"]}>
        <p className={styles["tips-info"]}>
          If your symptoms are serious, please seek immediate medical attention.
          Otherwise CoviCare will assign you to a medical doctor that will
          continuously follow-up with you.
          <br></br>
          <br></br>
        ...
        <ul className={styles["tips-list"]}>
          <li>
            Find out when and where to get tested if you have not done so
            already.
          </li>
          ...
          <li>
            While you are in quarantine, do not go to work, to school or to
            public places. Ask someone to bring you supplies.
          </li>
          <li>
          ...
          <li>
            Monitor yourself for any symptoms for 14 days and log them into
            CoviCare.
          </li>
          <li>
            Contact your medical doctor immediately if you have any of these
            danger signs: difficulty breathing, loss of speech or mobility,
            confusion or chest pain.
          </li>
        </ul>

        <p className={styles["tips-info"]}>
          We are here to help you get through this, so contact your doctor if
          you have any questions about your health.
        </p>
      </div>

      <hr />

      <div className={styles["todays-new-title"]}>Useful</div>
      ...
      <div className={styles["card-container"]}>
        <Card style={{ width: "18rem", margin: "2px" }}>
          <Card.Body>
            ...
            <Card.Text>
              Don't know where to get tested? Here is a link to help you get
              tested as soon as possible.
            </Card.Text>
            <Card.Link href="#">
              https://www.quebec.ca/en/health/health-issues/a-z/2019-coronavirus/testing-for-covid-19
            </Card.Link>
          </Card.Body>
        </Card>
        ...
        <Card style={{ width: "18rem", margin: "2px" }}>
          <Card.Body>
            ...
            <Card.Text>
              Feeling overwhelmed? Here are some resouces to get the support you
              need.
            </Card.Text>
            <Card.Link href="#">
              https://www.quebec.ca/en/health/advice-and-prevention/mental-health/get-help-with-mental-health/mental-health-help-and-support-resources
            </Card.Link>
          </Card.Body>
        </Card>
        ...
        <Card style={{ width: "18rem", margin: "2px" }}>
          <Card.Body>
            ...
            <Card.Text>
              Canada's #ScienceExplained is an initiative to help you understand
              various aspects of the pandemic through written and video
              information provided by experts.
            </Card.Text>
            <Card.Link href="#">
              https://covid19resources.ca/public/science-explained/
            </Card.Link>
          </Card.Body>
        </Card>
      </div>
