...
function CovidFile(props) {
  ...
  const updatePatientForm = async () => {
    ...
    axios
      .post(
        `/patient/update-status-form/${currentUser.user.uid}`,
        userAttributes
      )
  ...
  const showModalForCovidFormUpdate = (formIndex) => {
    ...
    if (patientData[formIndex].doctorQuestions) {
      setPatientAnswers(
        JSON.parse(JSON.stringify(patientData[formIndex].doctorQuestions))
      );
    }
    ...
    <div>
            ...
            return (
              <Accordion.Item eventKey={index} key={index}>
                ...
                <Accordion.Body>
                  ...
                  <Button
                    variant="info"
                    onClick={() => showModalForCovidFormUpdate(index)}
                  >
                    Update
                  </Button>
                </Accordion.Body>
      ...
      <Modal show={showModal} onHide={closeModal}>
        <Modal.Header closeButton>
          <Modal.Title>
            {selectedFormIndex >= 0 ? "Update a " : "Create a new "} covid
            status form
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form>
            ...
            {haveFever && (
              <>
                ...
                <input
                  ...
                  defaultValue={
                    selectedFormIndex >= 0
                      ? patientData[selectedFormIndex].temperature
                      : null
                  }
                  min={0}
                  step=".01"
            ...
            {other && (
              <>
                ...
                <textarea
                  ...
                  defaultValue={
                    selectedFormIndex >= 0
                      ? patientData[selectedFormIndex].otherSymptoms
                      : null
                  }
            ...
            {haveSymptoms && (
              <>
                ...
                <textarea
                  ...
                  defaultValue={
                    selectedFormIndex >= 0
                      ? patientData[selectedFormIndex].symptomDetails
                      : null
                  }
            ...
            <textarea
              ...
              defaultValue={
                selectedFormIndex >= 0
                  ? patientData[selectedFormIndex].health
                  : null
              }
                    ...
                    return (
                      <div key={index}>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            updatePatientAnswer(e.target.value, index)
                          }
                        />
                      </div>
                    );
