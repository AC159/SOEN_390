...
function CovidFile(props) {
    ...
    return (
        ...
        <div>
             <div className={styles[((patientData ?  Object.values(patientData)[Object.keys(patientData).indexOf("covidStatus")] : "None") === "None" &&
            (patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("temperature")] : "") === "" &&
            (patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("otherSymptoms")] : "") === "" &&
            (patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("symptomDetails")] : "") === "" &&
            (patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("health")] : "") === "" &&
            ...
            (patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("symptoms")].length : 0) ===  0)
                ...
                <div>
                    <div className={styles[(patientData ? Object.keys(patientData).indexOf("patientUid") : null) === null ? 'visible_CovidFile' : 'hidden_CovidFile']}>
                            ...
                            <form>
                                ...
                                <div
                                    ...
                                    <div className={styles[haveFever ? 'visible_CovidFile' : 'hidden_CovidFile']}>
                                        ...
                                        <input type="number"  defaultValue={patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("temperature")] : null}  min={0} step=".01" onChange={(e) => setTemp(e.target.value)}/>
                                    </div>

                                    <div className={styles[other ? 'visible_CovidFile' : 'hidden_CovidFile']}>
                                        <br/>
                                        <h6>What are the other symptoms?  </h6>
                                        <textarea rows="4" cols="50" defaultValue={patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("otherSymptoms")] : null}  onChange={(e) => setWhatOtherSymptoms(e.target.value)}/>
                                    </div>

                                <div  className={styles[haveSymptoms === "yes" ? 'visible_CovidFile' : 'hidden_CovidFile']}>
                                     <br/>
                                    <h6>Anything to add about your symptoms? </h6>
                                    <textarea rows="4" cols="50" defaultValue={patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("symptomDetails")] : null}  onChange={(e) => setSymptomDetails(e.target.value)}/>
                                </div>

                                 <br/>
                                <h6>Anything to add about your health? </h6>
                                <textarea rows="4" cols="50" defaultValue={patientData ? Object.values(patientData)[Object.keys(patientData).indexOf("health")] : null}  onChange={(e) => setHealth(e.target.value)}/>
